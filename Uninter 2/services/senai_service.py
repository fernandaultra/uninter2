"""
Serviço para coleta de cursos do SENAI
"""
...
class SenaiService(BaseService):
    """Serviço para coleta de cursos do SENAI"""
    
    def __init__(self):
        super().__init__()
        self.url = "https://www.portaldaindustria.com.br/senai/cursos/?estado=RJ"
        self.plataforma = "SENAI"
    ...
    def _encontrar_elementos_cursos(self, soup):
        ...
        if not elementos:
            ...
            for div in divs:
                if any(palavra in div.get('class', []) for palavra in ['curso', 'course', 'card', 'item']):
