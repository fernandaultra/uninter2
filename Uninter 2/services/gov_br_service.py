"""
Serviço para coleta de cursos do Gov.br
"""
...
class GovBrService(BaseService):
    """Serviço para coleta de cursos do Gov.br"""
    
    def __init__(self):
        super().__init__()
        self.url = "https://www.escolavirtual.gov.br/"
        self.plataforma = "Gov.br"
    ...
    def _encontrar_elementos_cursos(self, soup):
        ...
        if not elementos:
            ...
            for div in divs:
                if any(palavra in div.get('class', []) for palavra in ['curso', 'course', 'card', 'item', 'evg']):
